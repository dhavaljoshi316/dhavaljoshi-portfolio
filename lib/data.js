...
export const heroContent = {
    ...
    isOpenToShow: true,
    openTo: 'Always open to Remote • Freelance • Full-Time • Contract Opportunities'
};
...
export const contactContent = {
    ...
    email: "joshidhaval731@gmail.com",
...
export const projectsContent = {
    ...
    projects: [
        ...
        },
        {
            ...
            category: "Corporate",
            type: "Web Dashboard",
            description: "Developed responsive Dashboard about GPS Tracking data, with LazyGrid component for Performance optimization.",
            technologies: ["React.js", "React Component", "Bootstrap", "Material UI", "jQuery", "JavaScript", 'RestAPI', 'CSS'],
            androidLink: null,
            iOSLink: null,
            github: null
        },
        {
            ...
            category: "Corporate",
            type: "Mobile Application",
            description: "Developed Android and iOS Application of VRL Bus Booking as Developer at Infinity Infoway Ltd.",
            technologies: ["React Native", "Redux Toolkit", "Firebase", "RestAPI", "ReactNative Reanimated", "ReactNative Maps"],
            androidLink: null,
            iOSLink: null,
            github: null
        ...
        {
            name: "University CMS Project",
            image: null,
            company: 'Atmiya Univesity - M.C.A Project',
            category: "Academic Project",
            type: "Web",
            description: "Developed a full-stack University Content Management System to digitize and streamline academic and administrative operations. The platform features secure role-based authentication for admins, faculty, and students, enabling efficient management of departments, courses, enrollments, attendance, assignments, timetables, and announcements. It includes a centralized dashboard with real-time data insights and is built with a scalable backend architecture and responsive UI for seamless performance.",
            technologies: ["HTML", "CSS", "JavaScript", "Bootstrap", "React.js", "ASP.NET", 'WebAPIs', 'MS SQL Server'],
            androidLink: null,
            iOSLink: null,
            github: null
        },
        {
            name: `"LIFEROOT" - Blood Banks Management System Project`,
            image: null,
            company: 'Atmiya Univesity - B.C.A Project',
            category: "Academic Project",
            type: "Web",
            description: "Developed a Blood Bank Management System as my BCA final-year project using PHP to manage blood donors, blood stock, requests, and availability. The system includes secure admin authentication, donor registration, blood group tracking, request management, and real-time inventory updates to ensure efficient and reliable blood bank operations.",
            technologies: ["HTML", "CSS", "JavaScript", "Bootstrap", "PHP", 'WebAPIs', 'ORACLE'],
            androidLink: null,
            iOSLink: null,
            github: null
        },
    ...
    categories: [
        ...
        },
        {
            ...
            items: [
                ...
                { name: "iOS xCode", icon: null },
                { name: "Play Store Deployment", icon: null },
                { name: "App Store Deployment", icon: null },
                { name: "CodePush", icon: null },
                { name: "CLI", icon: null },
                { name: "Expo", icon: null },
            ]
        },
